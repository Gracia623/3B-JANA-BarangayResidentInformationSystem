...
class ZoneThree extends StatefulWidget {
  const ZoneThree({Key? key}) : super(key: key);

  @override
  State<ZoneThree> createState() => _ZoneThreeState();
}

class _ZoneThreeState extends State<ZoneThree> {
  List<String> names = [
    'Fernando Amorsolo',
    'Juan Luna',
                  ...
                  return Container(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          child: Stack(
                            alignment: Alignment.centerRight, // Aligns the edit and delete buttons to the right
                            children: [
                              TextButton(
