...
class ZoneFour extends StatefulWidget {
  const ZoneFour({Key? key}) : super(key: key);

  @override
  State<ZoneFour> createState() => _ZoneFourState();
}

class _ZoneFourState extends State<ZoneFour> {
  List<String> names = [
    'The Beatles',
    'Queen',
    'Rolling Stones',
